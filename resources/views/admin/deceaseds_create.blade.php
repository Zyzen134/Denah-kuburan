...
<div class="bg-white rounded-lg shadow-sm overflow-hidden max-w-3xl">
    ...
    <div class="p-6">
        ...
        <form action="{{ route('admin.deceaseds.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <!-- Upload Foto -->
            <div>
                <label for="photo" class="block text-sm font-medium text-gray-700 mb-1">Upload Foto Wajah Almarhum (Opsional)</label>
                ...
                <p class="text-xs text-gray-500 mt-1">Format yang diizinkan: JPG, JPEG, PNG. Maksimal 2MB.</p>
            </div>
